...
return [
    ...
    'uploaded' => 'File :attribute gagal diunggah. Ukuran file mungkin terlalu besar (maks 15MB per file). Pastikan server dikonfigurasi dengan benar.',

@extends('layouts.app')
@section('title', 'Galeri Surat Keluar')
@section('content')
<div class="space-y-6">
    <!-- Header -->
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold" style="color: var(--text-primary);">Galeri Surat Keluar</h1>
            <p style="color: var(--text-secondary);">Dokumen lampiran surat keluar</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
        ...
        <div class="rounded-xl p-4 border" style="background-color: var(--bg-card); border-color: var(--border-color);">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-lg flex items-center justify-center bg-orange-100 text-orange-600"><i class="bx bx-send text-xl"></i></div>
                <div>
                    <p class="text-xl font-bold" style="color: var(--text-primary);">{{ $letters->total() }}</p>
                    <p class="text-xs" style="color: var(--text-secondary);">Surat Keluar</p>
                </div>
            </div>
        </div>
        <div class="rounded-xl p-4 border" style="background-color: var(--bg-card); border-color: var(--border-color);">
            ...
            <table class="w-full" id="gallery-table">
                <thead style="background-color: var(--bg-input);">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left text-xs font-semibold uppercase cursor-pointer hover:opacity-70" style="color: var(--text-secondary);" onclick="sortTable(2)"><i class="bx bx-sort-alt-2 mr-1"></i>Kepada</th>
                ...
                <tbody class="divide-y" style="border-color: var(--border-color);">
                    ...
                    <tr class="hover:opacity-80">
                        ...
                        <td class="px-4 py-3" style="color: var(--text-primary);">{{ $letter->to }}</td>
                        <td class="px-4 py-3">

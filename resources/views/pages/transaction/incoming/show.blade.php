                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-center justify-between p-3 rounded-lg" style="background-color: var(--bg-input);">
                        <div class="flex items-center gap-3 flex-1 min-w-0">
                            ...
                            <img src="{{ route('attachment.serve', $attachment->id) }}" class="w-12 h-12 rounded-lg object-cover cursor-pointer hover:opacity-80" onclick="openAttachmentGallery({{ $index }})" alt="{{ $attachment->filename }}">
                            @else
                        ...
                        <div class="flex gap-1 ml-2">
                            ...
                            <a href="{{ route('attachment.download', $attachment->id) }}" target="_blank" class="p-2 rounded-lg text-sm btn-primary" title="Download">

...
<div class="space-y-6">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold" style="color: var(--text-primary);">Buku Agenda Surat Keluar</h1>
            <p style="color: var(--text-secondary);">Rekap surat keluar berdasarkan periode</p>
        </div>
        <a href="{{ route('agenda.outgoing.print', request()->query()) }}" target="_blank" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg font-medium  btn-primary"><i class="bx bx-printer"></i> Cetak</a>
    </div>
